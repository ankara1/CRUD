...
public class Controlador {
	...
	@Autowired
	private ClienteDAO elDAO;
	
	@RequestMapping("/lista")
	public String lista(Model modelo) {
		List<CRUD> losclientes=elDAO.getCRUD();													//almaceno dentro de este List losclientes el CRUD con todos los registros del CRUD para luego recorrerlos con un bucle forEach desde la pagina de la vista
